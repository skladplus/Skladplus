/**
 * Бизнес-логика без фреймворка и без базы: ни React, ни Next, ни Prisma,
 * ни packages/db. Границу проверяет шаг CI — импорты и манифест. Иначе логика
 * прирастает к фреймворку и перестаёт тестироваться отдельно.
 */
